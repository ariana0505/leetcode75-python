# 21. House Robber / Ladron de Casas
...
Eres un ladron profesional que planea robar casas a lo largo de una calle. Cada casa tiene una cierta cantidad de dinero guardado, pero existe una restriccion importante: **las casas adyacentes tienen sistemas de seguridad conectados**, y si se roban dos casas contiguas la misma noche, la policia sera alertada.
...
Salida: 4
Explicacion: Roba la casa 1 (dinero = 1) y la casa 3 (dinero = 3). Total = 1 + 3 = 4.
```
...
Salida: 12
Explicacion: Roba la casa 1 (dinero = 2), la casa 3 (dinero = 9) y la casa 5 (dinero = 1). Total = 2 + 9 + 1 = 12.
```
